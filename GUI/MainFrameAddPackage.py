...
class MainFrameAddPackage(CTkFrame):
    ...
    def create_package(self):
        ...
        create_package_frame.rowconfigure(0, weight=1, uniform='a')
        create_package_frame.rowconfigure(1, weight=8, uniform='a')
        ...
        datetime_frame.grid(column=0 , row= 1, sticky="s", pady=10, padx=10)

        datetime_frame.columnconfigure((0,1), weight=1, uniform='a')
        ...
        def cal_get():
            ...
            Headline.grid(column=0, row=0, sticky="nsew", padx=20)
            ...
            cal.grid(column= 0, row=1, pady = 20, padx=20, sticky="nsew")
